...
public class ActivityFormularioGuia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formulario_guia);
    ...
    private void guardarRespuestas() {
        ...
        db.collection("modulos")
                .document("modulo_3") // <--- CAMBIO AQUÍ
                .collection("ejercicios_guiados")
                .add(datos)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(this, "¡Gracias por tu respuesta!", Toast.LENGTH_LONG).show();
                    startActivity(new Intent(this, ejercicios.class));
                    finish();
                })
